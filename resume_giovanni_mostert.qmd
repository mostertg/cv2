...
{\bf HONOURS \& AWARDS}
  ...
  \begin{multicols}{2}
    \begin{flushleft}
      \textbf{$1^{st}$ Place Winner, COVID‑19 Tweet Sentiment Analysis with Web App}
...
\begin{large}
  \begin{multicols}{2}
    \begin{flushleft}
      \textbf{Count on Me Certificate of Excellence for Fraud Detection System}
      \textit{MTC Namibia}
    \end{flushleft}
    \begin{flushright}2018\end{flushright}
  \end{multicols}
...
\begin{large}
  \begin{multicols}{2}
    \begin{flushleft}
      \textbf{Chief Technology Officer’s Award for Outstanding Service}
      \textit{MTC Namibia}
    \end{flushleft}
...
\begin{large}
  \begin{multicols}{2}
    \begin{flushleft}
      \textbf{Best $1^{st}$ Year Student (Overall)}
...
\begin{large}
  \begin{multicols}{2}
    \begin{flushleft}
      \textbf{Best $1^{st}$ Year Student (Dept. of Informatics) }
      \textit{Namibia University of Science \& Technology}
    \end{flushleft}
    \begin{flushright}2015\end{flushright}
  \end{multicols}
...
{\bf CERTIFICATION}
  ...
  \begin{multicols}{2}
    \begin{flushleft}
      \textbf{NAMS/ISO/IEC 27001:2021 Development \& Implementation of Information Security Framework}
...
\begin{large}
  \begin{multicols}{2}
    \begin{flushleft}
      \textbf{Dialogic BorderNet Session Border Controller Certified}
      \textit{Dialogic}
    \end{flushleft}
    \begin{flushright}2020\end{flushright}
  \end{multicols}
...
\begin{large}
  \begin{multicols}{2}
    \begin{flushleft}
      \textbf{CS Core Telecommunications Advanced}
      \textit{Huawei}
    \end{flushleft}
...
\begin{large}
  \begin{multicols}{2}
    \begin{flushleft}
      \textbf{CS Core Telecommunications Fundamentals}
      \textit{Huawei}
    \end{flushleft}
...
{\bf COMMITTEES, MEMBERSHIPS \& OTHER ACTIVITIES}
  ...
  \begin{multicols}{2}
    \begin{flushleft}
      \textbf{Data Governance Project Team Member}
      \textit{TM Forum}
      \end{flushleft}
